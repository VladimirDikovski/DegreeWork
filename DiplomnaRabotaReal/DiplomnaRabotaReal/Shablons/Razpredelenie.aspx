<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Razpredelenie.aspx.cs" Inherits="DiplomnaRabotaReal.Shablons.Razpredelenie" %>
    ...
    <form id="form1" runat="server">
        ...
        <section>
            <div class="content">
                ...
                <br />
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Font-Bold="True" Width="1000px">
                    <Columns>
