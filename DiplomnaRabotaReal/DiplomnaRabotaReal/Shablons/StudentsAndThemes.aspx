<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StudentsAndThemes.aspx.cs" Inherits="DiplomnaRabotaReal.Shablons.StudentsAndThemes" %>
    ...
    <form id="form1" runat="server">
        ...
        <section>
            <div class="content">
                ...
                <br />
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="White" BorderStyle="Ridge" BorderWidth="2px" CellPadding="3" CellSpacing="1" GridLines="None" Font-Bold="True">
                    <Columns>
