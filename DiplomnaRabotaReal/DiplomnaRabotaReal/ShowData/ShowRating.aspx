<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShowRating.aspx.cs" Inherits="DiplomnaRabotaReal.ShowData.ShowRating" %>
        ...
        <section>
          ...
          <h1>
            Данни за Оценките<br /><br /><br />
              ...
              <Columns>                
                    <asp:BoundField  HeaderText="Оценка на разработка" DataField="RatingOfDevelopment"/>
                   <asp:BoundField  HeaderText="Оценка на защита" DataField="RatingOfProtection"/>
              </Columns>
